...
(function() {
    ...
    function changeColor(operation){
    	//var regex = new RegExp('color\ (\w)+');
    	//console.log(regex.test(operation));
    	
    	var res = operation.split(" ");
    	console.log($('span').css('background-color', res[1])); 
    }
